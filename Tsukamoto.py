...
# proses fuzzyfikasi : kadar gas

x_asasp = input ("masukan nilai  = asap ")
x_alkohol = input ("masukan nilai  = alkohol")
x_gas = input ("masukan nilai  = gas ")

asap= int (x_asap)
alkohol = int (x_alkohol)
gas = int (x_gas)


# menghitung intensitas asap
if asap<= 300 :
    value_sedikit = 1
    value_banyak = 0
if asap > 300 and cahaya < 1000 :
     value_sedikit = (1000- cahaya)/(1000 - 300)
     value_banyak = (cahaya - 300)/(1000 - 300)
if asap >= 1000 :
     value_sedikit = 0
     value_banyak= 1

#print ('intensitas asap ')

#print ('intensitas asap', value_sedikit)
#print ('intensitas asap', value_banyak)



# menghitung nilai kadar alkohol
if kele <=30 :
    value_kering = 1
    value_ideal = 0
    value_lembab = 0
